...
// monitoredTx represents a set of information used to build the tx, and the information
// to monitor if the transaction was sent successfully
type monitoredTx struct {
	// owner is the common identifier among all the monitored tx to identify who created
	// this. It is a identifier provided by the caller in order to be used in the future
	// to query the monitored tx by the owner. This allows the caller to be free of
	// implementing a persistence layer to monitor the txs
	owner string
